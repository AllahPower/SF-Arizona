...
using unsafe DoesExistDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, int>;
using unsafe GetColorAsArgbDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, uint>;
using unsafe GetColorAsRgbaDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, uint>;
using unsafe GetDistanceToLocalPlayerDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, float>;
using unsafe GetStatusDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, int>;
using unsafe SetColorDelegate = delegate* unmanaged[Thiscall]<CRemotePlayer*, uint, void>;
