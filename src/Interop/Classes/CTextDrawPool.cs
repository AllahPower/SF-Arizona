...
using unsafe CreateDelegate = delegate* unmanaged[Thiscall]<CTextDrawPool*, int, CTextDrawTransmit*, byte*, CTextDraw*>;
...
public unsafe ref struct CTextDrawPool
{
    ...
    public CTextDraw* Create(int textDrawId, in CTextDrawTransmit transmit, string text)
    {
        ...
        return _create(RequireInstance(), textDrawId, &copy, textAnsi);
    }
