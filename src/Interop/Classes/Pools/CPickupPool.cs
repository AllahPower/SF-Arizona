...
using unsafe CreateDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, SFSharp.Runtime.Interop.Classes.Pools.Pickup*, ushort, void>;
using unsafe CreateWeaponDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, int, System.Numerics.Vector3, int, ushort, void>;
using unsafe DeleteDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, int, void>;
using unsafe DeleteWeaponDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, ushort, void>;
using unsafe GetIndexDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, int, int>;
using unsafe ProcessDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, void>;
using unsafe SendNotificationDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Pools.CPickupPool*, int, void>;
...
public unsafe ref struct CPickupPool
{
    ...
    public int GetHandle(int pickupIndex)
    {
        CPickupPool* instance = RequireInstance();
        if (!IsValidIndex(pickupIndex))
        {
        ...
        return GetHandleArray(instance)[pickupIndex];
    }

    public uint GetTimer(int pickupIndex)
    {
        CPickupPool* instance = RequireInstance();
        if (!IsValidIndex(pickupIndex))
        {
        ...
        return GetTimerArray(instance)[pickupIndex];
    }

    public ref readonly WeaponPickup GetWeaponPickup(int pickupIndex)
    {
        CPickupPool* instance = RequireInstance();
        if (!IsValidIndex(pickupIndex))
        {
        ...
        return ref GetWeaponArray(instance)[pickupIndex];
    }

    public bool DoesExist(int pickupIndex)
    {
        return IsValidIndex(pickupIndex) && GetHandle(pickupIndex) != 0;
    }
    ...
    private static int* GetHandleArray(CPickupPool* instance)
    {
        return (int*)((byte*)instance + SampOffsets.CPickupPool.Handles);
    }
    ...
    private static uint* GetTimerArray(CPickupPool* instance)
    {
        return (uint*)((byte*)instance + SampOffsets.CPickupPool.Timers);
    }

    private static WeaponPickup* GetWeaponArray(CPickupPool* instance)
    {
        return (WeaponPickup*)((byte*)instance + SampOffsets.CPickupPool.Weapons);
    }
