...
using unsafe GetDelegate = delegate* unmanaged[Thiscall]<CObjectPool*, ushort, CObject*>;
using unsafe GetIdDelegate = delegate* unmanaged[Thiscall]<CObjectPool*, CObject*, int>;
...
public unsafe ref struct CObjectPool
{
    ...
    {
        return _get(RequireInstance(), objectId);
    }
    ...
    {
        return _getId(RequireInstance(), obj);
    }
