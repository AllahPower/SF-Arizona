...
using unsafe AddAccessoryDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int, SFSharp.Runtime.Interop.Classes.Entities.CPedAccessory*, void>;
using unsafe ClearWeaponsDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, void>;
using unsafe DeleteAccessoryDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int, void>;
using unsafe DeleteAllAccessoriesDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, void>;
using unsafe DisableJetpackDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, void>;
using unsafe EnableJetpackDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, void>;
using unsafe GetAccessoryDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int, nint>;
using unsafe GetAccessoryStateDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int, int>;
using unsafe GetAimZDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float>;
using unsafe GetArmourDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float>;
using unsafe GetBonePositionDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, uint, System.Numerics.Vector3*, void>;
using unsafe GetCurrentWeaponAmmoDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, ushort>;
using unsafe GetCurrentWeaponDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, byte>;
using unsafe GetHealthDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float>;
using unsafe GetRotationDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float>;
using unsafe GetStateDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, byte>;
using unsafe GetVehicleDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, SFSharp.Runtime.Interop.Classes.Entities.CVehicle*>;
using unsafe GetVehicleSeatIndexDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int>;
using unsafe HasAccessoryDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int>;
using unsafe HasJetpackDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int>;
using unsafe IsPassengerDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, int>;
using unsafe SetAimZDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float, void>;
using unsafe SetArmourDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float, void>;
using unsafe SetHealthDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float, void>;
using unsafe SetRotationDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, float, void>;
using unsafe SetStateDelegate = delegate* unmanaged[Thiscall]<SFSharp.Runtime.Interop.Classes.Entities.CPed*, byte, void>;
